	...
	public function show_customfields( $post, $args ) {
		...
		?>
			...
			<div>
				...
				<div style="border:solid 2px <?php echo $color; ?>; margin: 24px auto; border-radius:8px; width:80%; min-width:800px; title="<?php echo $field; ?>" <?php echo '事業者確認' === $field ? 'visibility: hidden; height: 0;' : 'visibility: visible'; ?>">
					<!-- ラベル -->
