...
class N2_Setpost {
	...
	public function show_customfields( $post, $args ) {
		...
		$input_tags = array(
			...
			'image'            => '<div class="%1$s-image-block"><input type="hidden" class="%1$s-image-input" name="%2$s[]" value="%3$s"><span class="%1$s-image-delete dashicons dashicons-no-alt"></span><img class="%1$s-image-url" src="%3$s" alt="" width="100%%" height="100%%" /></div>',
