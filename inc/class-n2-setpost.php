...
class N2_Setpost {
	...
	public function show_customfields( $post, $args ) {
		...
		$input_tags = array(
			...
			'image'            => '<div class="%1$s-image-block"><input type="hidden" class="%1$s-image-input" name="%2$s[]" value="%3$s"><button type="button" class="button button-secondary %1$s-image-delete">削除</button><img class="%1$s-image-url" src="%3$s" alt="" width="100%%" height="100%%" /></div>',
