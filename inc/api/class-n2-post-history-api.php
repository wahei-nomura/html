				...
				case 'table':
					...
					$result = array_map(
						function( $v ) {
							...
							unset( $v['site_id'], $v['SiteID'], $v['SiteURL'], $v['PostUrl'], $v['EditorLinkPost'], $v['MetaLink'], $v['MetaID'], $v['RevisionLink'], $v['OldDate'], $v['NewDate'], $v['object'], $v['created_on'], $v['alert_id'], $v['user_agent'], $v['severity'], $v['user_id'], $v['session_id'], $v['post_type'], $v['event_type'], $v['occurrence_id'], $v['post_id'], $v['client_ip'], $v['id'] );
							return $v;
						},
						$result
					);
