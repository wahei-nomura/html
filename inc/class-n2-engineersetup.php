...
class N2_Engineersetup {
	...
	public function __construct() {
		...
		add_action( 'wp_enqueue_scripts', array( $this, 'setup_menu_style' ) );
	}
	...
	public function add_setup_menu_page() {
		...
		<div class="wrap">
			...
			<div class="row">
				<h2>事業者連絡先</h2>
				<div>事業者さまとのやりとりに使用するメールアドレス・電話番号を記入してください。</div>
				<div>メールアドレス</div>
			</div>
		</div>
		<?php
	...
	public function setup_menu_style() {
		wp_enqueue_style( 'n2-setupmenu', get_template_directory_uri() . '/dist/setupmenu.css', array(), wp_get_theme()->get( 'Version' ), true );
	}
