...
<table class="form-table">
	...
	<tr>
		<th>FTPユーザー</th>
		<td>
			<input type="text" name="n2_settings[楽天][FTP][user]" value="<?php echo esc_attr( $n2->settings['楽天']['FTP']['user'] ); ?>" <?php wp_readonly( ! $n2->settings_access ); ?>>
		</td>
	</tr>
	<tr>
		<th>FTPパスワード</th>
	...
	<tr>
		<th>商品画像ディレクトリ</th>
		<td>
			<input type="text" name="n2_settings[楽天][商品画像ディレクトリ]" value="<?php echo esc_attr( $n2->settings['楽天']['商品画像ディレクトリ'] ); ?>" <?php wp_readonly( ! $n2->settings_access ); ?>>
		</td>
	</tr>
	<tr>
		<th>共通タグID</th>
		<td>
			<input type="text" name="n2_settings[楽天][共通タグID]" value="<?php echo esc_attr( $n2->settings['楽天']['共通タグID'] ); ?>" style="width: 100%;" <?php wp_readonly( ! $n2->settings_access ); ?>>
		</td>
	</tr>
	<tr>
		<th>説明文追加html</th>
		<td>
			...
			<textarea name="n2_settings[楽天][説明文追加html]" style="width: 100%;" rows="10" <?php wp_readonly( ! $n2->settings_access ); ?>><?php echo esc_attr( $n2->settings['楽天']['説明文追加html'] ); ?></textarea>
		</td>
	</tr>
	<tr>
		<th>項目選択肢</th>
