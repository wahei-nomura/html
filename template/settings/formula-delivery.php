...
<table class="form-table">
	...
	<tr>
		...
		<td>
			<p style="margin-bottom: 1em;">
				<input type="hidden" name="n2_settings[寄附金額・送料][税込送料]">
				<label>
					<input type="checkbox" name="n2_settings[寄附金額・送料][税込送料]" value="1" <?php checked( $n2->settings['寄附金額・送料']['税込送料'] ?? '' ); ?>> 税込送料　<small>↓税込送料の場合は全て税込で入力</samll>
				</label>
			</p>
	...
	<tr>
		...
		<td>
			<label style="margin: 0 2em 0 0;">
				<input type="checkbox" name="n2_settings[寄附金額・送料][送料][レターパックライト]" value="370" <?php checked( $n2->settings['寄附金額・送料']['送料']['レターパックライト'] ?? '', 370 ); ?>> レターパックライト
			</label>
			<label>
				<input type="checkbox" name="n2_settings[寄附金額・送料][送料][レターパックプラス]" value="520" <?php checked( $n2->settings['寄附金額・送料']['送料']['レターパックプラス'] ?? '', 520 ); ?>> レターパックプラス
			</label>
		</td>
	</tr>
</table>
